...
inline void save_particle_fn(ParticleEmitter& emitter, nlohmann::json& root) {
...
inline void load_particle_fn(ParticleEmitter& emitter, nlohmann::json& root, double total_elapsed_seconds) {
