...
struct OutlineQuad final : RenderableInterface {
    OutlineQuad(Renderer* renderer, Rect2D rect, TextureSource texture, OutlinePushConstantData pc_data, BufferID global_data_buffer)
        : rect(rect)
        , shader_pair(
