...
DescriptorSetLayout::DescriptorSetLayout(Renderer* renderer, std::span<const VkDescriptorSetLayoutBinding> bindings, VkDescriptorSetLayoutCreateFlags flags) { 
...
DescriptorSet::DescriptorSet(Renderer* renderer, const DescriptorSetLayout& layout) {
